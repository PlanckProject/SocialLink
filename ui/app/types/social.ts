...
export interface GroupStyle { layout: 'list' | 'grid'; link_radius: string; icon_radius: string; spacing: string }
export const DEFAULT_GROUP_STYLE: GroupStyle = { layout: 'list', link_radius: '22%', icon_radius: '50%', spacing: '12px' }
